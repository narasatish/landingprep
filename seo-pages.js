(function() {
  ...
  const ARTICLES = [
    ...
    },
    {
      ...
      sections: [
        ...
        { h: "Week 3\u20134: Section-specific drilling", body: "Mon/Wed/Fri: Listening + Reading drills (one full section each, 45 min). Tue/Thu: Writing Task 2 (one essay every other day, marked against the Band 7 sample). Weekend: Speaking practice with a partner or AI Speaking Agent \u2014 30 min each side." },
    ...
    },
    {
      ...
      sections: [
        ...
        { h: "Practise it free", body: "Open the LandingPrep Learning Club for 40+ Task 2 prompts with Band 7 model answers, or paste your own essay into the AI Writing Agent for instant feedback on Task Response, Coherence, Lexical Resource and Grammar." }
      ]
    },
    {
      id: "pte-79-plus-fast",
  ...
  function BlogIndex({ onNav, onOpen }) {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "blog", onNav }), /* @__PURE__ */ React.createElement("div", { className: "seo-shell" }, /* @__PURE__ */ React.createElement("div", { className: "seo-hero" }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "Study Tips \xB7 Strategy \xB7 Comparisons"), /* @__PURE__ */ React.createElement("h1", { className: "h1", style: { marginTop: 8, fontSize: "clamp(32px,5vw,48px)" } }, "Free guides for serious test-takers"), /* @__PURE__ */ React.createElement("p", { className: "body-lg muted", style: { maxWidth: 720, marginTop: 12 } }, "Evidence-based strategies, score targets by country, exam comparisons, and study plans \u2014 written for IELTS, TOEFL, PTE, CELPIP, Duolingo, GRE, and GMAT Focus.")), /* @__PURE__ */ React.createElement("div", { className: "seo-grid" }, ARTICLES.map((a) => {
