(function() {
  ...
  const TYPE_META = {
    ...
    summarize_group_discussion: { label: "Summarize Group Discussion", icon: "\u{1F5E3}\uFE0F", mode: "speak", prep: 10, resp: 120 },
    respond_to_situation: { label: "Respond to a Situation", icon: "\u{1F4AC}", mode: "speak", prep: 20, resp: 40 },
