...
function LearningClub({ onNav, exams, embedded }) {
  ...
  const body = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "lc-hero" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 12 } }, "Learning Club \xB7 Free"), /* @__PURE__ */ React.createElement("h1", { className: "h1" }, "Topics, model answers & vocabulary"), /* @__PURE__ */ React.createElement("p", { className: "body-lg muted", style: { maxWidth: 620, marginTop: 16 } }, "Full-length model answers at real exam word counts, speaking samples at real exam timing, and curated vocabulary with usage examples \u2014 for every exam."), /* @__PURE__ */ React.createElement("div", { className: "lc-widgets" }, /* @__PURE__ */ React.createElement("div", { className: "lc-widgets-col" }, /* @__PURE__ */ React.createElement(WordOfDay, null), /* @__PURE__ */ React.createElement(Flashcards, null)), /* @__PURE__ */ React.createElement(DailyChallenge, null)))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--tint)", borderBottom: "1px solid var(--line)" } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "exam-selector-row" }, examIds.map((id) => {
...
function TipsMistakes({ content, examId }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, tips.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "guide-card", style: { marginBottom: 20 } }, /* @__PURE__ */ React.createElement("h2", { className: "h2" }, "Last-minute tips"), /* @__PURE__ */ React.createElement("ul", { style: { paddingLeft: 18, margin: "12px 0 0", color: "var(--ink-2)", lineHeight: 1.8 } }, tips.map((t, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { marginBottom: 8 } }, t)))), mistakes.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h2", { className: "h2" }, "Common mistakes"), /* @__PURE__ */ React.createElement("ul", { className: "cm-list", style: { marginTop: 12 } }, mistakes.map((m, i) => /* @__PURE__ */ React.createElement("li", { key: i }, m)))), !tips.length && !mistakes.length && /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F4A1}"), /* @__PURE__ */ React.createElement("p", null, "Tips and mistakes content coming soon.")));
}
