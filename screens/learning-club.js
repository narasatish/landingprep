...
\u2022 Percentage change = (New \u2013 Old) / Old \xD7 100
\u2022 Successive discounts: multiply the factors, don't add (e.g., 20% then 15% off = 1 \u2013 0.80\xD70.85 = 32% off, not 35%)
\u2022 Ratio problems: use a multiplier variable (e.g., if ratio is 3:5, set amounts as 3x and 5x)
\u2022 To find what percent A is of B: (A/B) \xD7 100`,
        formulas: ["% change = (new \u2013 old)/old \xD7 100", "Harmonic mean (for average rate) = 2ab/(a+b)", "If A:B = m:n, then A = m/(m+n) of total"],
        ...
        solution: "Net price = 1.40 \xD7 0.75 = 1.05 of original. Net change = +5%. The item is 5% more expensive than the original price.",
        trap: "Candidates often add percentage changes (40% \u2013 25% = 15% increase). Always multiply the factors."
      },
      {
        topic: "Work and Rate Problems",
        concept: `Work problems follow the formula: Work = Rate \xD7 Time.
...
\u2022 Rule of thumb: 'choosing a committee' = combination; 'arranging on a shelf' = permutation`,
        ...
        solution: "9C4 = 9!/(4!\xD75!) = (9\xD78\xD77\xD76)/(4\xD73\xD72\xD71) = 3024/24 = 126.",
...
KEY STRATEGY: When algebra gets complex, try Picking Numbers \u2014 substitute simple values that satisfy any given constraints and test each answer option.`,
        formulas: ["Distance = Rate \xD7 Time", "Profit = Revenue \u2013 Cost", "Simple interest = PRT; Compound interest = P(1+r/n)^(nt)", "Average = Sum/Count"],
        example: "If x\xB2 \u2013 5x + 6 = 0, what is the value of x\xB2 + x?",
        solution: "Factor: (x\u20132)(x\u20133)=0 \u2192 x=2 or x=3. If x=2: x\xB2+x = 4+2=6. If x=3: x\xB2+x=9+3=12. Both values are possible \u2014 check if the question restricts to one solution. If no restriction, the answer would be listed as both in a select-all question, or the test would provide more context.",
        trap: "Solving for x and forgetting to evaluate the expression asked for \u2014 the question asks for x\xB2+x, not x."
      }
    ],
...
function WordOfDay() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "word-of-day" }, /* @__PURE__ */ React.createElement("div", { className: "wod-label" }, "\u{1F4D6} Word of the day"), /* @__PURE__ */ React.createElement("div", { className: "wod-word" }, word.w, " ", /* @__PURE__ */ React.createElement("span", { className: "wod-pos" }, word.pos)), /* @__PURE__ */ React.createElement("div", { className: "wod-def" }, word.def), /* @__PURE__ */ React.createElement("div", { className: "wod-ex" }, "\u201C", word.ex, "\u201D"));
}
function loadFlash() {
  try {
    return JSON.parse(localStorage.getItem("lp_flash") || "{}");
  } catch (e) {
    return {};
  }
}
function saveFlash(s) {
  try {
    localStorage.setItem("lp_flash", JSON.stringify(s));
  } catch (e) {
  }
}
function Flashcards() {
  ...
  function begin() {
    ...
    if (!q.length) q = [...words].sort(() => Math.random() - 0.5).slice(0, 10);
    setQueue(q);
    setIdx(0);
    setRevealed(false);
    setReviewed(0);
  ...
  function rate(grade) {
    ...
    st[key] = { ease, ivl, due: Date.now() + Math.max(0, ivl) * 864e5 };
    saveFlash(st);
    setReviewed((r) => r + 1);
    let nq = queue;
    if (grade === 0) {
  ...
  if (!open) {
    return /* @__PURE__ */ React.createElement("div", { className: "flash-launch-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "flash-decks" }, DECKS.map((d) => /* @__PURE__ */ React.createElement("button", { key: d.id, className: "flash-deck-chip" + (d.id === deckId ? " active" : ""), onClick: () => setDeckId(d.id) }, d.name))), /* @__PURE__ */ React.createElement("button", { className: "flash-launch", onClick: begin }, "\u{1F0CF} Practise ", (DECKS.find((d) => d.id === deckId) || DECKS[0]).name, " flashcards"));
  }
  const finished = idx >= queue.length;
  if (finished) {
    return /* @__PURE__ */ React.createElement("div", { className: "flashcard-shell" }, /* @__PURE__ */ React.createElement("div", { className: "flashcard-done" }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 40 } }, "\u2705"), /* @__PURE__ */ React.createElement("h3", { style: { margin: "6px 0" } }, "Session complete!"), /* @__PURE__ */ React.createElement("p", { className: "muted", style: { margin: 0 } }, "You reviewed ", reviewed, " card", reviewed !== 1 ? "s" : "", ". Spaced repetition schedules each word for the best time to review."), /* @__PURE__ */ React.createElement("div", { className: "row-gap-12", style: { marginTop: 14, justifyContent: "center" } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: begin }, "Study again"), /* @__PURE__ */ React.createElement("button", { className: "btn", onClick: () => setOpen(false) }, "Close"))));
  }
  const card = queue[idx];
  return /* @__PURE__ */ React.createElement("div", { className: "flashcard-shell" }, /* @__PURE__ */ React.createElement("div", { className: "flashcard-top" }, /* @__PURE__ */ React.createElement("span", null, "Card ", idx + 1, " of ", queue.length), /* @__PURE__ */ React.createElement("button", { className: "flash-close", onClick: () => setOpen(false) }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "flashcard" + (revealed ? " is-flipped" : ""), onClick: () => !revealed && setRevealed(true) }, /* @__PURE__ */ React.createElement("div", { className: "flash-word" }, card.w, " ", /* @__PURE__ */ React.createElement("span", { className: "flash-pos" }, card.pos)), revealed ? /* @__PURE__ */ React.createElement("div", { className: "flash-back" }, /* @__PURE__ */ React.createElement("div", { className: "flash-def" }, card.def), /* @__PURE__ */ React.createElement("div", { className: "flash-ex" }, "\u201C", card.ex, "\u201D")) : /* @__PURE__ */ React.createElement("div", { className: "flash-tap" }, "Tap to reveal definition")), revealed && /* @__PURE__ */ React.createElement("div", { className: "flash-rate" }, /* @__PURE__ */ React.createElement("button", { className: "fr-btn again", onClick: () => rate(0) }, "Again"), /* @__PURE__ */ React.createElement("button", { className: "fr-btn hard", onClick: () => rate(1) }, "Hard"), /* @__PURE__ */ React.createElement("button", { className: "fr-btn good", onClick: () => rate(2) }, "Good"), /* @__PURE__ */ React.createElement("button", { className: "fr-btn easy", onClick: () => rate(3) }, "Easy")));
}
const CHALLENGES = [
...
function DailyChallenge() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "daily-challenge" }, /* @__PURE__ */ React.createElement("div", { className: "dc-label" }, "\u{1F3AF} Daily challenge"), /* @__PURE__ */ React.createElement("div", { className: "dc-q" }, c.q), /* @__PURE__ */ React.createElement("div", { className: "dc-opts" }, c.opts.map((o, i) => {
    const chosen = pick === i;
    const state = pick == null ? "" : i === c.a ? " correct" : chosen ? " wrong" : "";
    return /* @__PURE__ */ React.createElement("button", { key: i, className: "dc-opt" + state, disabled: pick != null, onClick: () => setPick(i) }, /* @__PURE__ */ React.createElement("span", { className: "dc-letter" }, ["A", "B", "C", "D"][i]), o, pick != null && i === c.a && /* @__PURE__ */ React.createElement("span", { className: "dc-tick" }, "\u2713"));
  })), pick != null && /* @__PURE__ */ React.createElement("div", { className: "dc-result" + (pick === c.a ? " ok" : " no") }, pick === c.a ? "Correct! " : "Not quite. ", c.exp, " ", /* @__PURE__ */ React.createElement("span", { className: "dc-back" }, "Come back tomorrow for a new one.")));
}
function LearningClub({ onNav, exams }) {
  ...
  const [extras, setExtras] = useStateLC({});
  React.useEffect(() => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "learning", onNav }), /* @__PURE__ */ React.createElement("section", { className: "lc-hero" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 12 } }, "Learning Club \xB7 Free"), /* @__PURE__ */ React.createElement("h1", { className: "h1" }, "Topics, model answers & vocabulary"), /* @__PURE__ */ React.createElement("p", { className: "body-lg muted", style: { maxWidth: 620, marginTop: 16 } }, "Full-length model answers at real exam word counts, speaking samples at real exam timing, and curated vocabulary with usage examples \u2014 for every exam."), /* @__PURE__ */ React.createElement("div", { className: "lc-widgets" }, /* @__PURE__ */ React.createElement("div", { className: "lc-widgets-col" }, /* @__PURE__ */ React.createElement(WordOfDay, null), /* @__PURE__ */ React.createElement(Flashcards, null)), /* @__PURE__ */ React.createElement(DailyChallenge, null)))), /* @__PURE__ */ React.createElement("div", { style: { background: "var(--tint)", borderBottom: "1px solid var(--line)" } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "exam-selector-row" }, examIds.map((id) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { className: "esb-dot", style: { background: id === activeExam ? "#fff" : ex.colour } }),
      ex.short || ex.name
    );
  })))), /* @__PURE__ */ React.createElement("div", { className: "lc-tabs-outer" }, /* @__PURE__ */ React.createElement("div", { className: "shell", style: { display: "flex" } }, tabs.map((t) => /* @__PURE__ */ React.createElement("button", { key: t, className: "lc-tab" + (t === activeTab ? " active" : ""), onClick: () => setActiveTab(t) }, t)))), /* @__PURE__ */ React.createElement("div", { className: "lc-body" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, activeTab === "Writing" && /* @__PURE__ */ React.createElement(WritingTopics, { content, examId: activeExam }), activeTab === "Speaking" && /* @__PURE__ */ React.createElement(SpeakingTopics, { content, examId: activeExam }), activeTab === "Vocabulary" && /* @__PURE__ */ React.createElement(VocabularySection, { content }), activeTab === "Math/Verbal" && /* @__PURE__ */ React.createElement(MathSection, { content }), activeTab === "Tips & Mistakes" && /* @__PURE__ */ React.createElement(TipsMistakes, { content, examId: activeExam }))), /* @__PURE__ */ React.createElement(window.LP_Footer, null));
}
function topicTag(prompt) {
  const p = (prompt || "").toLowerCase();
  if (/\b(chart|graph|table|diagram|process|map|figure)\b/.test(p)) return { label: "Task 1 \xB7 Data", color: "#0e7490" };
...
function WritingTopics({ content, examId }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "lc-topics-head" }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "Writing Topics & Model Answers \u2014 ", topics.length, " topics"), /* @__PURE__ */ React.createElement(
    "input",
    {
      className: "lc-search",
      type: "search",
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "lc-topic-list" }, filtered.map((t, i) => /* @__PURE__ */ React.createElement(TopicCard, { key: t.id, topic: t, index: i + 1, isOpen: openId === t.id, onToggle: () => setOpenId(openId === t.id ? null : t.id) })), !filtered.length && /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F50D}"), /* @__PURE__ */ React.createElement("p", null, "No topics match \u201C", query, "\u201D."))), /* @__PURE__ */ React.createElement("div", { className: "note", style: { marginTop: 16 } }, "Model answers are written at Band 7 / equivalent proficiency level for illustrative purposes. Real exam answers should reflect your own ideas under timed conditions \u2014 clear organisation, relevant content, varied vocabulary and accurate grammar, not perfection."));
}
function SpeakingTopics({ content, examId }) {
  const [openId, setOpenId] = useStateLC(null);
  const topics = content.speaking || [];
  if (!topics.length) return /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F3A4}"), /* @__PURE__ */ React.createElement("p", null, "Speaking content coming soon for this exam."));
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 20 } }, "Speaking Topics & Sample Answers"), topics.map((t) => /* @__PURE__ */ React.createElement("div", { key: t.id, className: "topic-card", style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: "topic-card-head",
      style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 22px", cursor: "pointer", background: openId === t.id ? "var(--tint)" : void 0 },
      onClick: () => setOpenId(openId === t.id ? null : t.id)
    },
    /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 4 } }, t.part ? `Part ${t.part}` : "Speaking"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--serif)", fontSize: 17, letterSpacing: "-0.01em" } }, t.prompt.slice(0, 80), t.prompt.length > 80 ? "..." : "")),
    /* @__PURE__ */ React.createElement("span", { style: { fontSize: 22, color: "var(--ink-3)" } }, openId === t.id ? "\u2212" : "+")
  ), openId === t.id && /* @__PURE__ */ React.createElement("div", { style: { padding: "0 22px 22px" } }, /* @__PURE__ */ React.createElement("div", { className: "writing-prompt", style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("strong", null, "Full prompt"), t.prompt), t.approach && /* @__PURE__ */ React.createElement("div", { className: "topic-card", style: { padding: "10px 14px", marginBottom: 12, fontSize: 13, color: "var(--ink-3)", fontStyle: "italic" } }, "Approach: ", t.approach), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--ink-3)", marginBottom: 8 } }, "Sample Answer (Band 7 / equivalent)"), /* @__PURE__ */ React.createElement("div", { className: "sample-answer" }, t.band7Answer || t.sampleAnswer), t.keyVocab && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8 } }, "Key vocabulary"), /* @__PURE__ */ React.createElement("div", { className: "vocab-pills" }, t.keyVocab.map((v, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: "vocab-pill" }, v))))))));
}
function TopicCard({ topic, index, isOpen, onToggle }) {
  const tag = topicTag(topic.prompt);
  return /* @__PURE__ */ React.createElement("div", { className: "topic-card" + (isOpen ? " is-open" : "") }, /* @__PURE__ */ React.createElement("div", { className: "tc-head", onClick: onToggle }, index != null && /* @__PURE__ */ React.createElement("span", { className: "tc-index", style: { background: tag.color + "18", color: tag.color } }, String(index).padStart(2, "0")), /* @__PURE__ */ React.createElement("div", { className: "tc-head-main" }, /* @__PURE__ */ React.createElement("span", { className: "tc-tag", style: { background: tag.color + "14", color: tag.color } }, tag.label), /* @__PURE__ */ React.createElement("div", { className: "tc-title" }, topic.prompt.slice(0, 110), topic.prompt.length > 110 ? "\u2026" : "")), /* @__PURE__ */ React.createElement("span", { className: "tc-toggle", "aria-hidden": true }, isOpen ? "\u2212" : "+")), isOpen && /* @__PURE__ */ React.createElement("div", { className: "tc-body" }, /* @__PURE__ */ React.createElement("div", { className: "tc-prompt" }, /* @__PURE__ */ React.createElement("strong", { style: { display: "block", marginBottom: 8, fontSize: 11, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--ink-3)" } }, "Full prompt"), topic.prompt), topic.approach && /* @__PURE__ */ React.createElement("div", { className: "tc-approach" }, "\u{1F4A1} Approach: ", topic.approach), /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8, marginTop: 4 } }, "Model answer (Band 7 / equivalent)"), /* @__PURE__ */ React.createElement("div", { className: "sample-answer" }, topic.band7Answer || topic.sampleAnswer), topic.vocab && topic.vocab.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8 } }, "Key vocabulary for this topic"), /* @__PURE__ */ React.createElement("div", { className: "vocab-pills" }, topic.vocab.map((v, i) => /* @__PURE__ */ React.createElement("span", { key: i, className: "vocab-pill" }, v))))));
}
function VocabularySection({ content }) {
  var _a;
  const topics = content.vocabularyTopics || [];
  const flatVocab = content.vocabulary || [];
  const [openTopic, setOpenTopic] = useStateLC(((_a = topics[0]) == null ? void 0 : _a.topic) || null);
  const [search, setSearch] = useStateLC("");
  if (topics.length) {
    const wordCount = topics.reduce((s, t) => {
      var _a2;
      return s + (((_a2 = t.items) == null ? void 0 : _a2.length) || 0);
    }, 0);
    const q = search.trim().toLowerCase();
    const filteredTopics = q ? topics.map((t) => ({
      ...t,
      items: (t.items || []).filter((it) => (it.word || "").toLowerCase().includes(q) || (it.meaning || "").toLowerCase().includes(q))
    })).filter((t) => t.items.length) : topics;
    const activeTopic = q ? filteredTopics[0] : filteredTopics.find((t) => t.topic === openTopic) || filteredTopics[0];
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 12 } }, "Vocabulary \u2014 ", topics.length, " topics \xB7 ", wordCount, " words"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        placeholder: "\u{1F50D} Search by word or meaning...",
        value: search,
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "vocab-layout", style: { display: "grid", gap: 24, gridTemplateColumns: "minmax(0, 220px) minmax(0, 1fr)" } }, /* @__PURE__ */ React.createElement("div", { className: "vocab-topic-rail" }, filteredTopics.map((t) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: t.topic,
      ...
      t.topic,
      " ",
      /* @__PURE__ */ React.createElement("span", { className: "vocab-topic-count" }, t.items.length)
    ))), /* @__PURE__ */ React.createElement("div", { className: "vocab-items" }, activeTopic ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("h3", { style: { margin: "0 0 14px", fontFamily: "var(--serif)", fontSize: 22, letterSpacing: "-0.01em", textTransform: "capitalize" } }, activeTopic.topic), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 12 } }, (activeTopic.items || []).map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "q-card", style: { padding: "16px 20px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0, flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--serif)", fontSize: 19, letterSpacing: "-0.01em" } }, v.word), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "var(--ink-3)", marginTop: 3 } }, /* @__PURE__ */ React.createElement("em", null, v.meaning))), v.usageNote && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", background: "var(--tint)", padding: "4px 10px", borderRadius: 999, whiteSpace: "nowrap" } }, v.usageNote)), v.example && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, fontSize: 14, color: "var(--ink-2)", lineHeight: 1.6, borderLeft: "3px solid var(--line-2)", paddingLeft: 12 } }, '"', v.example, '"'))))) : /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("p", null, "No matches.")))));
  }
  if (!flatVocab.length) return /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F4DA}"), /* @__PURE__ */ React.createElement("p", null, "Vocabulary section coming soon."));
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 20 } }, "Academic Vocabulary"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gap: 14 } }, flatVocab.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "q-card", style: { padding: "18px 22px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--serif)", fontSize: 20, letterSpacing: "-0.01em" } }, v.word), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "var(--ink-3)", marginTop: 4 } }, /* @__PURE__ */ React.createElement("em", null, v.meaning))), Array.isArray(v.synonyms) && v.synonyms.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "vocab-pills" }, v.synonyms.map((s, j) => /* @__PURE__ */ React.createElement("span", { key: j, className: "vocab-pill" }, s)))), v.example && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, fontSize: 14, color: "var(--ink-2)", lineHeight: 1.6, borderLeft: "3px solid var(--line-2)", paddingLeft: 12 } }, '"', v.example, '"')))));
}
function MathSection({ content }) {
  const [openIdx, setOpenIdx] = useStateLC(null);
  const topics = content.math || [];
  if (!topics.length) return /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F522}"), /* @__PURE__ */ React.createElement("p", null, "Math content available for GRE and GMAT."));
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 20 } }, "Quantitative / Math Concepts"), topics.map((t, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "topic-card", style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "tc-head", onClick: () => setOpenIdx(openIdx === i ? null : i) }, /* @__PURE__ */ React.createElement("div", { className: "tc-title" }, t.topic), /* @__PURE__ */ React.createElement("span", { className: "tc-toggle" }, openIdx === i ? "\u2212" : "+")), openIdx === i && /* @__PURE__ */ React.createElement("div", { className: "tc-body" }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--ink-2)", lineHeight: 1.7, marginBottom: 16, whiteSpace: "pre-wrap" } }, t.concept), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8 } }, "Key formulas"), t.formulas.map((f, j) => /* @__PURE__ */ React.createElement("div", { key: j, style: { fontFamily: "var(--mono)", fontSize: 13, background: "var(--tint)", padding: "8px 12px", borderRadius: "var(--r-sm)", marginBottom: 6, border: "1px solid var(--line)" } }, f))), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8 } }, "Example question"), /* @__PURE__ */ React.createElement("div", { className: "writing-prompt" }, t.example)), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 8 } }, "Step-by-step solution"), /* @__PURE__ */ React.createElement("div", { className: "sample-answer" }, t.solution)), t.trap && /* @__PURE__ */ React.createElement("div", { className: "note" }, "\u26A0 Common trap: ", t.trap)))));
}
function TipsMistakes({ content, examId }) {
  var _a;
  const tips = content.tips || [];
  const mistakes = content.mistakes || ((_a = LC_CONTENT[examId]) == null ? void 0 : _a.mistakes) || [];
  return /* @__PURE__ */ React.createElement("div", null, tips.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "guide-card", style: { marginBottom: 20 } }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Last-minute tips"), /* @__PURE__ */ React.createElement("ul", { style: { paddingLeft: 18, margin: "12px 0 0", color: "var(--ink-2)", lineHeight: 1.8 } }, tips.map((t, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { marginBottom: 8 } }, t)))), mistakes.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Common mistakes"), /* @__PURE__ */ React.createElement("ul", { className: "cm-list", style: { marginTop: 12 } }, mistakes.map((m, i) => /* @__PURE__ */ React.createElement("li", { key: i }, m)))), !tips.length && !mistakes.length && /* @__PURE__ */ React.createElement("div", { className: "empty-state" }, /* @__PURE__ */ React.createElement("div", { className: "es-icon" }, "\u{1F4A1}"), /* @__PURE__ */ React.createElement("p", null, "Tips and mistakes content coming soon.")));
}
