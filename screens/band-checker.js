...
Return ONLY a JSON object: {"overall": <score 0-10>, "wordCount": <int>, "criteria": [{"key":"Clarity of purpose","score":<0-10>,"comment":"<one sentence>"},{"key":"Specificity & evidence","score":<0-10>,"comment":"<one sentence>"},{"key":"Structure & flow","score":<0-10>,"comment":"<one sentence>"},{"key":"Language & tone","score":<0-10>,"comment":"<one sentence>"}], "strengths": ["<2-3 short points>"], "improvements": ["<4-5 specific, actionable points: vague claims to make concrete, clich\xE9s to cut, missing details to add>"], "corrections": [{"original":"<a weak or clich\xE9 phrase taken from the SOP>","fixed":"<a stronger, specific rewrite>"}], "band9Rewrite": "<a stronger, more specific rewrite of the OPENING paragraph (3-4 sentences) that hooks the reader>"}`;
        const d = await evaluate(prompt);
        if (!d || d.overall == null) throw new Error("parse");
        setData(d);
        try {
          window.LP_Gamify && window.LP_Gamify.award(30, "sop review");
        } catch (e) {
        }
      } catch (e) {
        setErr("Couldn't review that \u2014 please try again (the AI may be warming up).");
      }
      setBusy(false);
    }
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "tool-card" }, /* @__PURE__ */ React.createElement("p", { style: { margin: "0 0 10px", color: "var(--ink-3, #667085)", fontSize: 14 } }, "Paste your Statement of Purpose and get instant, specific feedback on clarity, specificity, structure and tone \u2014 plus a stronger opening. Your text isn't stored."), /* @__PURE__ */ React.createElement("textarea", { className: "bc-textarea", rows: 12, placeholder: "Paste your Statement of Purpose (SOP) here\u2026", value: text, onChange: (e) => setText(e.target.value) }), /* @__PURE__ */ React.createElement("div", { className: "bc-meta" }, /* @__PURE__ */ React.createElement("span", { className: words < 150 ? "bc-words low" : "bc-words ok" }, words, " words ", words < 150 ? "\xB7 an SOP is usually 500\u20131000 words" : "\u2713"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", disabled: busy || words < 80, onClick: check }, busy ? "Reviewing\u2026" : "Review my SOP \u2192")), err && /* @__PURE__ */ React.createElement("div", { className: "bc-err" }, err)), busy && /* @__PURE__ */ React.createElement("div", { className: "tool-card bc-loading" }, "\u23F3 The AI consultant is reading your SOP and checking clarity, specificity and structure\u2026"), /* @__PURE__ */ React.createElement(BandResult, { data, rewriteLabel: "Stronger opening paragraph", overallLabel: "SOP Score / 10" }));
  }
  function BandChecker({ onNav, initialMode }) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "tools", onNav }), /* @__PURE__ */ React.createElement("main", { className: "tools-shell tools-shell-wide" }, /* @__PURE__ */ React.createElement("header", { className: "tools-hero" }, /* @__PURE__ */ React.createElement("h1", null, "\u{1F3AF} Band-Score Checker"), /* @__PURE__ */ React.createElement("p", null, "Paste your essay or record your speaking answer \u2014 get an instant estimated IELTS band with a full criterion breakdown, fixes and a Band 9 model. 100% free, no signup.")), /* @__PURE__ */ React.createElement("div", { className: "tools-tabs" }, /* @__PURE__ */ React.createElement("button", { className: "tools-tab" + (mode === "writing" ? " active" : ""), onClick: () => setMode("writing") }, "\u270D\uFE0F Writing"), /* @__PURE__ */ React.createElement("button", { className: "tools-tab" + (mode === "speaking" ? " active" : ""), onClick: () => setMode("speaking") }, "\u{1F399}\uFE0F Speaking"), /* @__PURE__ */ React.createElement("button", { className: "tools-tab" + (mode === "sop" ? " active" : ""), onClick: () => setMode("sop") }, "\u{1F4DD} SOP Review")), mode === "writing" ? /* @__PURE__ */ React.createElement(WritingChecker, null) : mode === "speaking" ? /* @__PURE__ */ React.createElement(SpeakingChecker, null) : /* @__PURE__ */ React.createElement(SopReviewer, null)), /* @__PURE__ */ React.createElement(window.LP_Footer, null));
  }
