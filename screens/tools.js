...
(function() {
  ...
  function Tabs({ tab, setTab }) {
    const t = [["planner", "\u{1F4C5} Study Plan"], ["convert", "\u{1F501} Score & Eligibility"], ["reading", "\u26A1 Reading Speed"], ["shadow", "\u{1F3A4} Listen & Repeat"]];
