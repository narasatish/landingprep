...
(function() {
  ...
  function ReadingSpeed() {
    ...
    useEffect(() => {
      ...
      const t = setInterval(() => setElapsed(Math.max(0, Math.round((Date.now() - startRef.current) / 1e3))), 250);
    ...
    const finish = () => {
      const secs = (Date.now() - startRef.current) / 1e3;
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "tool-card" }, /* @__PURE__ */ React.createElement("h2", null, "Reading Speed Test"), /* @__PURE__ */ React.createElement("p", { className: "tool-sub" }, "No microphone needed \u2014 this simply ", /* @__PURE__ */ React.createElement("strong", null, "times how fast you read"), ". Tap start, read the passage at your normal pace, then tap stop. IELTS, TOEFL and GRE reward 200+ words per minute with good comprehension."), phase === "ready" && /* @__PURE__ */ React.createElement("div", { className: "reading-cta" }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, p.title), " \xB7 ", p.words, " words"), /* @__PURE__ */ React.createElement("button", { className: "tool-btn", onClick: start }, "\u25B6 Start reading")), phase === "reading" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "reading-timerbar" }, "\u23F1 ", fmtT(elapsed), " \u2014 read at your normal pace, then tap stop"), /* @__PURE__ */ React.createElement("p", { className: "reading-text" }, p.text), /* @__PURE__ */ React.createElement("button", { className: "tool-btn", onClick: finish }, "\u23F9 I've finished \u2014 show my speed")), phase === "done" && (tooFast ? /* @__PURE__ */ React.createElement("div", { className: "reading-result warn" }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 34 } }, "\u{1F914}"), /* @__PURE__ */ React.createElement("div", null, "That was too quick to be a real read \u2014 tap start and read the whole passage at your normal pace."), /* @__PURE__ */ React.createElement("button", { className: "tool-btn ghost", onClick: () => setPhase("ready") }, "Try again")) : /* @__PURE__ */ React.createElement("div", { className: "reading-result " + v[1] }, /* @__PURE__ */ React.createElement("div", { className: "big-wpm" }, wpm, /* @__PURE__ */ React.createElement("span", null, " wpm")), /* @__PURE__ */ React.createElement("div", null, v[0]), /* @__PURE__ */ React.createElement("button", { className: "tool-btn ghost", onClick: () => setPhase("ready") }, "Try again"))));
  }
  function Shadow() {
