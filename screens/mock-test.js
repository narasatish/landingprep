...
function buildTest(examId, testType) {
  ...
  if (examId === "ielts") {
    ...
    if (testType === "full" || testType === "section_listening") {
      ...
      sections.push({ id: "listening", name: "Listening", icon: "\u{1F3A7}", timeSecs: 47 * 60, parts, type: "listening" });
    }
    if (testType === "full" || testType === "section_reading") {
      ...
      sections.push({ id: "reading", name: "Reading", icon: "\u{1F4D6}", timeSecs: 55 * 60, passages, type: "reading" });
    }
    if (testType === "full" || testType === "section_writing") {
...
function QuestionCard({ q, qi, sectionId, answer, onAnswer, hideInstruction }) {
  if (q.type === "mcq") {
    return /* @__PURE__ */ React.createElement("div", { className: "q-card" }, /* @__PURE__ */ React.createElement("div", { className: "q-num" }, "Question ", q.num || qi + 1), /* @__PURE__ */ React.createElement("div", { className: "q-text" }, q.text), q.visual && window.LP_VisualRenderer && /* @__PURE__ */ React.createElement(window.LP_VisualRenderer, { task: { visual: q.visual, prompt: q.text } }), q.passage && /* @__PURE__ */ React.createElement("div", { className: "passage-block", style: { maxHeight: 200, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("p", { style: { margin: 0 } }, q.passage)), /* @__PURE__ */ React.createElement("div", { className: "q-options" }, (q.options || []).map((opt, oi) => {
