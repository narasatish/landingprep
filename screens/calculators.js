...
(function() {
  ...
  function LoanCalc() {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "tool-card" }, /* @__PURE__ */ React.createElement("h2", null, "\u{1F4B0} Education Loan EMI Calculator"), /* @__PURE__ */ React.createElement("p", { className: "tool-sub" }, "Estimate your monthly repayment and total interest on an education loan."), /* @__PURE__ */ React.createElement("div", { className: "tool-row" }, /* @__PURE__ */ React.createElement("label", null, "Currency", /* @__PURE__ */ React.createElement("select", { value: cur, onChange: (e) => setCur(e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "\u20B9" }, "\u20B9 INR"), /* @__PURE__ */ React.createElement("option", { value: "$" }, "$ USD"), /* @__PURE__ */ React.createElement("option", { value: "\xA3" }, "\xA3 GBP"), /* @__PURE__ */ React.createElement("option", { value: "\u20AC" }, "\u20AC EUR"))), /* @__PURE__ */ React.createElement("label", null, "Loan amount", /* @__PURE__ */ React.createElement("input", { type: "number", value: amount, onChange: (e) => setAmount(e.target.value), placeholder: "e.g. 3000000" })), /* @__PURE__ */ React.createElement("label", null, "Interest rate (% p.a.)", /* @__PURE__ */ React.createElement("input", { type: "number", step: "0.1", value: rate, onChange: (e) => setRate(e.target.value) })), /* @__PURE__ */ React.createElement("label", null, "Tenure (years)", /* @__PURE__ */ React.createElement("input", { type: "number", value: years, onChange: (e) => setYears(e.target.value) }))), emi != null ? /* @__PURE__ */ React.createElement("div", { className: "convert-out" }, /* @__PURE__ */ React.createElement("div", { className: "convert-grid" }, /* @__PURE__ */ React.createElement("div", { className: "convert-cell" }, /* @__PURE__ */ React.createElement("span", null, "Monthly EMI"), /* @__PURE__ */ React.createElement("strong", null, fmt(emi))), /* @__PURE__ */ React.createElement("div", { className: "convert-cell" }, /* @__PURE__ */ React.createElement("span", null, "Total interest"), /* @__PURE__ */ React.createElement("strong", null, fmt(interest))), /* @__PURE__ */ React.createElement("div", { className: "convert-cell" }, /* @__PURE__ */ React.createElement("span", null, "Total payable"), /* @__PURE__ */ React.createElement("strong", null, fmt(total)))), /* @__PURE__ */ React.createElement("p", { className: "tool-note" }, "Indicative reducing-balance EMI. Actual terms (moratorium, processing fees, floating rates) vary by lender.")) : /* @__PURE__ */ React.createElement("p", { className: "tool-note" }, "Enter loan amount, rate and tenure to calculate."));
  }
