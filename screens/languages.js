...
(function() {
  ...
  function Languages({ onNav }) {
    ...
    if (!lang) return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "languages", onNav }), /* @__PURE__ */ React.createElement("main", { className: "tools-shell" }, /* @__PURE__ */ React.createElement("div", { className: "tool-card" }, /* @__PURE__ */ React.createElement("p", { className: "tool-sub" }, "Loading languages\u2026"))));
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "languages", onNav }), /* @__PURE__ */ React.createElement("main", { className: "tools-shell" }, /* @__PURE__ */ React.createElement("header", { className: "tools-hero" }, /* @__PURE__ */ React.createElement("h1", null, "Learn ", lang.name, " \u2014 100% Free \u{1F3A7}"), /* @__PURE__ */ React.createElement("p", null, lang.blurb)), /* @__PURE__ */ React.createElement("div", { className: "tools-groups" }, order.map((id) => /* @__PURE__ */ React.createElement("button", { key: id, className: "tools-group" + (langId === id ? " active" : ""), onClick: () => {
      setLangId(id);
      setTab("learn");
    } }, langs[id].flag, " ", langs[id].name))), /* @__PURE__ */ React.createElement("div", { className: "tools-tabs" }, [["learn", "\u{1F4DA} Learn"], ["vocab", "\u{1F5C2} Vocabulary"], ["speak", "\u{1F399}\uFE0F AI Speaking"], ["test", "\u2705 Placement Test"], ["exams", "\u{1F393} Exams & Why"]].map(([id, label]) => /* @__PURE__ */ React.createElement("button", { key: id, className: "tools-tab" + (tab === id ? " active" : ""), onClick: () => setTab(id) }, label))), tab === "learn" && /* @__PURE__ */ React.createElement(LearnView, { lang }), tab === "vocab" && /* @__PURE__ */ React.createElement(VocabView, { lang }), tab === "speak" && (window.LP_LangSpeak ? /* @__PURE__ */ React.createElement(window.LP_LangSpeak, { langId, key: langId }) : /* @__PURE__ */ React.createElement("div", { className: "tool-card" }, /* @__PURE__ */ React.createElement("p", { className: "tool-sub" }, "Loading speaking partner\u2026"))), tab === "test" && /* @__PURE__ */ React.createElement(TestView, { lang, key: langId }), tab === "exams" && /* @__PURE__ */ React.createElement(ExamsView, { lang, onNav })), /* @__PURE__ */ React.createElement(window.LP_Footer, null));
  }
