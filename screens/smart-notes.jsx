...
(function () {
  ...
  // mdInline: convert lightweight markdown (bold, italic) to React element nodes.
  // Escapes HTML, then replaces **text** → <strong> and *text* → <em>.
  function mdInline(s) {
    if (!s) return "";
  ...
  function SmartNote({ note }) {
    ...
    if (phase === "read") {
      return React.createElement("div", { style: { padding: "24px 20px" } },
        React.createElement("div", { className: "hero", style: { marginBottom: "24px", padding: "32px 24px" } },
        ...
        React.createElement("div", { className: "card", style: { marginBottom: "20px", padding: "20px" } },
        ...
        (note.chunks || []).map((chunk, idx) =>
          React.createElement("div", { key: idx, className: "card", style: { marginBottom: "20px", padding: "20px" } },
            ...
            React.createElement("div", { className: "callout tip", style: { background: "rgba(255, 193, 7, 0.08)", border: "1px solid rgba(255, 193, 7, 0.2)", borderRadius: "var(--r-lg)", padding: "14px", marginBottom: "12px" } },
              React.createElement("p", { style: { margin: "0", fontSize: "15px", lineHeight: "1.5", color: "var(--ink)" } },
                React.createElement("strong", {}, "💡 Real example:"), " " + chunk.realExample
              )
            ),
            React.createElement("div", { className: "callout", style: { background: "rgba(79, 70, 229, 0.06)", border: "1px solid rgba(79, 70, 229, 0.15)", borderRadius: "var(--r-lg)", padding: "14px" } },
              React.createElement("p", { style: { margin: "0", fontSize: "15px", lineHeight: "1.5", color: "var(--ink)" } },
                React.createElement("strong", {}, "🧠 Memory hook:"), " " + chunk.memoryHook
              )
            )
          )
        ),
    ...
    if (phase === "quiz") {
      ...
      return React.createElement("div", { style: { padding: "24px 20px" } },
        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", paddingBottom: "12px", borderBottom: "1px solid var(--line)" } },
        ...
        React.createElement("div", { className: "card", style: { padding: "24px", marginBottom: "20px" } },
        ...
        revealed && React.createElement(React.Fragment, {},
          React.createElement("div", { className: "card", style: { padding: "20px", marginBottom: "20px", background: "rgba(79, 70, 229, 0.04)" } },
    ...
    if (phase === "done") {
      return React.createElement("div", { style: { padding: "24px 20px" } },
        React.createElement("div", { className: "card", style: { padding: "32px 24px", textAlign: "center" } },
