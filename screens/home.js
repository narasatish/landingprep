...
function Home({ onGuide, onPractice, onNav }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.LP_TopBar, { current: "home", onNav }), /* @__PURE__ */ React.createElement(window.LP_Marquee, null), /* @__PURE__ */ React.createElement("main", { id: "main-content" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement(ReturningBar, { onNav })), /* @__PURE__ */ React.createElement("section", { className: "hero" }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "hero-inner-clean" }, /* @__PURE__ */ React.createElement("div", { className: "hero-meta" }, /* @__PURE__ */ React.createElement("span", { className: "chip" }, /* @__PURE__ */ React.createElement("span", { className: "dot", style: { background: "var(--leaf)" } }), " Trusted by students worldwide"), /* @__PURE__ */ React.createElement("span", { className: "chip" }, "100% free"), /* @__PURE__ */ React.createElement("span", { className: "chip" }, "No signup")), /* @__PURE__ */ React.createElement("div", { className: "hero-tagline" }, "\u{1F30D} ", LP_TAGLINE), /* @__PURE__ */ React.createElement("h1", { className: "display" }, "Prep for your exam.", /* @__PURE__ */ React.createElement("br", null), "Land your ", /* @__PURE__ */ React.createElement("em", { style: { fontStyle: "italic", fontFamily: "var(--serif)", color: "var(--accent)" } }, "dream university"), " abroad."), /* @__PURE__ */ React.createElement("p", { className: "body-lg muted", style: { maxWidth: 760, marginTop: 18, marginInline: "auto" } }, "1,000+ free mock tests across 15+ exams \u2014 IELTS, TOEFL, OET, PTE, GRE, GMAT, SAT & more \u2014 plus a complete study-abroad toolkit: college predictor, scholarships, SOP & visa guidance. All free, for students in every country."), /* @__PURE__ */ React.createElement("div", { className: "hero-cta" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary btn-lg", onClick: () => onNav("exam-prep") }, "Browse all mock tests \u2192"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-lg", onClick: () => {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "hhp-overlay" }), /* @__PURE__ */ React.createElement("div", { className: "hhp-cap" }, "Join students worldwide preparing for their dream universities \u2014 100% free.")))), /* @__PURE__ */ React.createElement("section", { className: "section lp-stats-section reveal", style: { paddingTop: 24, paddingBottom: 8 } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "lp-stats" }, [[exams.length + "+", "exams covered", "var(--accent)"], ["1,000+", "free mock tests", "#16a34a"], ["99", "universities", "#0ea5e9"], ["100%", "free, forever", "#f59e0b"], ["0", "signups to start", "#ec4899"]].map(([n, l, c]) => /* @__PURE__ */ React.createElement("div", { className: "lp-stat", key: l }, /* @__PURE__ */ React.createElement("span", { className: "lp-stat-n", style: { color: c } }, n), /* @__PURE__ */ React.createElement("span", { className: "lp-stat-l" }, l)))))), /* @__PURE__ */ React.createElement("section", { className: "section reveal", style: { paddingTop: 18 } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "section-header reveal" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "Why students choose LandingPrep"), /* @__PURE__ */ React.createElement("h2", { className: "h1" }, "Everything you need \u2014 from test prep to admission, ", /* @__PURE__ */ React.createElement("em", { style: { fontFamily: "var(--serif)", fontStyle: "italic", color: "var(--accent)" } }, "100% free"), "."), /* @__PURE__ */ React.createElement("p", { className: "muted", style: { maxWidth: 660, marginTop: 10 } }, "One platform replaces a dozen paid tools and a coaching centre \u2014 practise the exam, then plan your university, scholarship and visa journey."))), /* @__PURE__ */ React.createElement("div", { className: "lp-pros reveal" }, [
    ["\u{1F4DD}", "1,000+ realistic mocks", "Real timings & patterns across all 15+ exams with instant scoring.", "exam-prep"],
    ["\u{1F3A4}", "Speaking practice", "Speak into your mic, get live transcripts, follow-ups & fluency scoring.", "agents"],
    ...
    onNav("colleges");
  } }, "\u{1F393} Apply to 99+ universities"))), /* @__PURE__ */ React.createElement("div", { className: "sa-band-flags" }, [["\u{1F1FA}\u{1F1F8}", "USA"], ["\u{1F1EC}\u{1F1E7}", "UK"], ["\u{1F1E8}\u{1F1E6}", "Canada"], ["\u{1F1E6}\u{1F1FA}", "Australia"], ["\u{1F1E9}\u{1F1EA}", "Germany"], ["\u{1F1EE}\u{1F1EA}", "Ireland"], ["\u{1F1F3}\u{1F1FF}", "NZ"], ["\u{1F1F8}\u{1F1EC}", "Singapore"]].map(([f, n]) => /* @__PURE__ */ React.createElement("button", { key: n, className: "sa-flag", onClick: () => onNav("colleges"), title: "Study in " + n }, /* @__PURE__ */ React.createElement("span", null, f), n)))))), /* @__PURE__ */ React.createElement("section", { className: "section", style: { paddingTop: 28 } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "section-header reveal" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "eyebrow" }, "Choose your exam"), /* @__PURE__ */ React.createElement("h2", { className: "h1" }, "Every major exam. One free platform."), /* @__PURE__ */ React.createElement("p", { className: "muted", style: { maxWidth: 640, marginTop: 10 } }, "Click any exam to open its complete prep hub \u2014 pattern, registration, fees, score guide, mock tests, tips, and FAQs."))), /* @__PURE__ */ React.createElement("ul", { className: "exam-list-simple reveal" }, exams.map((e) => {
    ...
    ["\u{1F19A}", "Compare the tests", "IELTS vs PTE, IELTS vs TOEFL, GRE vs GMAT \u2014 side by side, with which to take.", "/english-test-comparisons/"],
    ["\u{1F504}", "Score converter", "Convert IELTS \u2194 TOEFL \u2194 PTE \u2194 CEFR \u2194 Duolingo with a full concordance table.", "/tools/english-test-score-converter/"],
    ["\u{1F30D}", "Score needed by country", "The exact English-test & admission score each country and university expects.", "/eligibility/"],
    ["\u{1F4B8}", "Scholarships by country", "Fully-funded and merit awards with eligibility, amounts and deadlines.", "/fully-funded-scholarships/"],
    ["\u{1F6C2}", "Test scores for PR & visa", "IELTS, PTE & CELPIP scores for Canada, Australia & UK immigration.", "/ielts-for-canada-pr/"],
    ["\u{1F4B0}", "Cost of studying abroad", "Add up tuition, living, visa & flights with the free cost calculator.", "/tools/cost-of-studying-abroad-calculator/"],
    ["\u{1F6C2}", "Visa interview questions", "Real F-1, UK, Canada & Australia student-visa questions, answered.", "/visa-interview/"],
    ["\u{1F4DD}", "SOP & LOR samples", "Complete statement-of-purpose & recommendation samples to adapt.", "/sop-samples/"],
    ["\u{1F4C5}", "Intakes & deadlines", "When to apply \u2014 intake seasons & deadlines for every country.", "/intakes/"],
    ["\u{1F9EE}", "IELTS band calculator", "Turn your raw Listening & Reading answers into the official 0\u20139 band.", "/tools/ielts-band-score-calculator/"]
  ].map(([ic, t, d, href]) => /* @__PURE__ */ React.createElement("a", { key: href, className: "hp-tool-card", href, style: { textDecoration: "none" } }, /* @__PURE__ */ React.createElement("span", { className: "hp-tool-ic" }, ic), /* @__PURE__ */ React.createElement("span", { className: "hp-tool-t" }, t), /* @__PURE__ */ React.createElement("span", { className: "hp-tool-d" }, d)))))), window.LP_GamifyCard && window.LP_AUTH && window.LP_AUTH.getUser() ? /* @__PURE__ */ React.createElement("section", { className: "section", style: { paddingTop: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "shell", style: { maxWidth: 760 } }, /* @__PURE__ */ React.createElement(window.LP_GamifyCard, null))) : null, /* @__PURE__ */ React.createElement("section", { className: "section", style: { paddingTop: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "shell" }, /* @__PURE__ */ React.createElement("div", { className: "eyebrow", style: { marginBottom: 12 } }, "Popular free tools"), /* @__PURE__ */ React.createElement("div", { className: "hp-tools-grid" }, [
    ["\u{1F3AF}", "Band Checker", "Instant IELTS Writing/Speaking band + Band 9 model", "writing-checker"],
