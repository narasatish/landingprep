...
function GuideDownload({ source } = {}) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      try {
        if (window.gtag) window.gtag("event", "guide_download", { source: source || "home" });
      } catch (e2) {
      }
    } catch (e2) {
    }
...
function GoalOnboarding({ onNav }) {
  ...
  ))), /* @__PURE__ */ React.createElement("button", { onClick: () => done("skip"), style: { display: "block", margin: "14px auto 0", background: "none", border: "none", color: "var(--ink-3, #667085)", fontSize: 14, cursor: "pointer", textDecoration: "underline", padding: "12px 16px", minHeight: 44 } }, "Just exploring \u2014 skip")));
}
...
function Footer() {
  ...
  ), /* @__PURE__ */ React.createElement("button", { type: "submit", className: "btn btn-primary", style: { padding: "10px 16px" } }, nlStatus === "sending" ? "\u2026" : "Get tips"), nlStatus === "ok" && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "var(--leaf)", width: "100%" } }, "\u2705 Subscribed \u2014 check your inbox!"), nlStatus === "err" && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "#dc2626", width: "100%" } }, "Please enter a valid email.")), pushStatus === "ok" ? /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--leaf)", marginTop: 10 } }, "\u{1F514} Reminders on \u2014 see you tomorrow!") : /* @__PURE__ */ React.createElement("button", { onClick: enablePush, className: "btn", style: { marginTop: 10, padding: "9px 14px", fontSize: 13 } }, "\u{1F514} Daily practice reminder"), pushStatus === "denied" && /* @__PURE__ */ React.createElement("p", { className: "muted", style: { fontSize: 12, marginTop: 6 } }, "Enable notifications in your browser settings to get reminders."), pushStatus === "unsupported" && /* @__PURE__ */ React.createElement("p", { className: "muted", style: { fontSize: 12, marginTop: 6 } }, "Reminders aren't supported on this browser/device."), window.LP_ExamReminder && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } }, React.createElement(window.LP_ExamReminder)), window.LP_PLAY_URL ? /* @__PURE__ */ React.createElement(
    "a",
    {
...
window.LP_Home = Home;
window.LP_GuideDownload = GuideDownload;
