...
function PatternTab({ exam }) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Test pattern & syllabus"), /* @__PURE__ */ React.createElement("p", null, "The ", exam.name, " runs for ", exam.duration, " across ", exam.sections, " sections. The structure below reflects the latest official format."), note && /* @__PURE__ */ React.createElement("div", { className: "live-note" }, "\u{1F195} ", /* @__PURE__ */ React.createElement("strong", null, "Latest:"), " ", note, window.LP_LIVE.updatedAt() && /* @__PURE__ */ React.createElement("span", { className: "live-stamp" }, " \xB7 updated ", window.LP_LIVE.updatedAt())), /* @__PURE__ */ React.createElement("dl", { style: { margin: "20px 0 0", padding: 0 } }, exam.pattern.map(([k, v], i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "row" }, /* @__PURE__ */ React.createElement("dt", null, k), /* @__PURE__ */ React.createElement("dd", null, v))))), exam.sections_detail && exam.sections_detail.map((sec) => /* @__PURE__ */ React.createElement("div", { key: sec.name, className: "guide-card", style: { marginTop: 16 } }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, sec.icon, " ", sec.name), /* @__PURE__ */ React.createElement("p", { style: { margin: "4px 0 12px", fontSize: 14, color: "var(--ink-3)" } }, sec.time, " minutes \xB7 ", sec.questions > 0 ? `${sec.questions} questions` : "variable tasks"), /* @__PURE__ */ React.createElement("div", { className: "guide-section-card" }, /* @__PURE__ */ React.createElement("div", { className: "gsc-name" }, "Question types"), /* @__PURE__ */ React.createElement("div", { className: "gsc-types" }, sec.types.map((t, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { marginBottom: 4 } }, "\u2022 ", t)))), /* @__PURE__ */ React.createElement("div", { className: "tip-box", style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("strong", null, "Exam tip"), sec.tips))));
}
...
function TipsTab({ exam }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Last-minute tips for ", exam.name), /* @__PURE__ */ React.createElement("ul", { style: { paddingLeft: 18, margin: "16px 0 0", color: "var(--ink-2)", lineHeight: 1.8 } }, examTips.map((t, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { marginBottom: 8 } }, t))));
}
function MistakesTab({ exam }) {
  const mistakes = exam.commonMistakes || [];
  return /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Common mistakes to avoid"), /* @__PURE__ */ React.createElement("p", { style: { marginBottom: 16 } }, "These are the most frequently observed errors by candidates preparing for ", exam.name, ". Address them in your practice sessions before test day."), /* @__PURE__ */ React.createElement("ul", { className: "cm-list" }, mistakes.map((m, i) => /* @__PURE__ */ React.createElement("li", { key: i }, m))));
}
function FAQsTab({ exam }) {
  const [open, setOpen] = useStateG(0);
  return /* @__PURE__ */ React.createElement("div", { className: "guide-card" }, /* @__PURE__ */ React.createElement("h3", { className: "h2" }, "Frequently asked questions"), /* @__PURE__ */ React.createElement("div", { className: "faq", style: { marginTop: 12 } }, exam.faqs.map(([q, a], i) => /* @__PURE__ */ React.createElement("details", { key: i, open: i === open, onToggle: () => setOpen(i) }, /* @__PURE__ */ React.createElement("summary", null, q), /* @__PURE__ */ React.createElement("p", null, a)))));
}
