...
const SPECS = {
  ...
  toefl: {
    ...
    reading:   { min: 20, max: 48, duration: { min: 1080, max: 4500 } },
    listening: { min: 28, max: 45, duration: { min: 1080, max: 2700 } },
  ...
  pte: {
    ...
    reading:            { min: 15, max: 25, duration: { min: 1740, max: 3600 } },
    listening:          { min: 17, max: 25, duration: { min: 1800, max: 3600 } },
  },
  celpip: {
