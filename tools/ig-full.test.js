...
let hasImage = false;
try { require("@resvg/resvg-js"); hasImage = true; } catch (e) { try { require("sharp"); hasImage = true; } catch (e2) {} }
...
(async () => {
  ...
  } else { console.log("  ↷ skip carousel render tests (no image renderer available)"); }
  ...
  } else { console.log("  ↷ skip image-post render tests (no image renderer available)"); }
  ...
  } else { console.log("  ↷ skip generateStory render test (no image renderer available)"); }
  ...
  } else { console.log("  ↷ skip reel tests (ffmpeg-static not installed)"); }
  ...
  } else { console.log("  ↷ skip carousel idempotency test (no image renderer available)"); }
