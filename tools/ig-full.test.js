...
(async () => {
  ...
  } else { console.log("  ↷ skip carousel render tests (resvg/sharp not installed)"); }
  ...
  } else console.log("  ↷ skip image-post render (resvg/sharp not installed)");
  ...
  }); else console.log("  ↷ skip story render (resvg/sharp not installed)");
