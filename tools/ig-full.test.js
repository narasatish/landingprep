...
(async () => {
  ...
  if (!hasImage) { console.log("  ↷ skip — @resvg/resvg-js and sharp both absent"); }
  ...
  if (!hasImage) console.log("  ↷ generateStory PNG skip — @resvg/resvg-js and sharp both absent");
  ...
  if (!hasImage) console.log("  ↷ carousel idempotency skip — @resvg/resvg-js and sharp both absent");
