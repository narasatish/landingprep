...
(async () => {
  ...
  } else { console.log("  ↷ skip [2] (sharp/@resvg/resvg-js not installed)"); }
  ...
  } else { console.log("  ↷ skip [3] (sharp/@resvg/resvg-js not installed)"); }
  ...
  } else { console.log("  ↷ skip generateStory PNG (sharp/@resvg/resvg-js not installed)"); }
  ...
  } else { console.log("  ↷ skip carousel determinism (sharp/@resvg/resvg-js not installed)"); }
