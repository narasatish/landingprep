...
(async () => {
  ...
  } else { console.log("  ↷ carousel/image rendering skipped — sharp/@resvg/resvg-js not available"); }
  ...
  } else { console.log("  ↷ image post rendering skipped — sharp not available"); }
  ...
  } else { console.log("  ↷ generateStory skipped — sharp not available"); }
  ...
  } else { console.log("  ↷ ffmpeg-static not available — reel tests skipped"); }
  ...
  } else { console.log("  ↷ carousel idempotency skipped — sharp not available"); }
