...
(async () => {
  ...
  } else { console.log("  ↷ skip [2] — @resvg/resvg-js and sharp not installed"); }
  ...
  } else { console.log("  ↷ skip [3] — @resvg/resvg-js and sharp not installed"); }
  ...
  } else { console.log("  ↷ skip generateStory PNG — @resvg/resvg-js and sharp not installed"); }
  ...
  } else { console.log("  ↷ skip carousel idempotency — @resvg/resvg-js and sharp not installed"); }
