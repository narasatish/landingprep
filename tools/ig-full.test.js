...
(async () => {
  ...
  if (!hasImage) { console.log("  ↷ skip — neither @resvg/resvg-js nor sharp installed"); }
  ...
  if (!hasImage) { console.log("  ↷ skip — image renderer not available"); }
  ...
  else console.log("  ↷ generateStory PNG skip — image renderer not available");
  ...
  else console.log("  ↷ carousel idempotency skip — image renderer not available");
