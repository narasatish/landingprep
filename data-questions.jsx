// LandingPrep — question bank v2
// All questions are original, written to match real exam formats and difficulty.
// Not copied from official tests or third-party banks.
window.LP_QUESTIONS = {
  ...
  ielts: {
    ...
    listening: {
      bandTable: [
        ...
        [32,7],[31,7],[30,6.5],[29,6.5],[28,6.5],[27,6],[26,6],[25,6],
        [23,5.5],[22,5.5],[21,5.5],[20,5.5],[19,5],[18,5],[17,5],[16,5],
        [15,4.5],[14,4.5],[13,4.5],[12,4],[11,4],[10,4],[0,0]
      ],
      parts: [
        {
          id: "l_p1", partNum: 1,
...
Receptionist: My pleasure! We look forward to seeing you.`,
          questions: [
            ...
            { id:"lp1q1_5", num:1, type:"form_completion",
              title:"RIVERSIDE SPORTS CENTRE — MEMBERSHIP APPLICATION",
              wordLimit:3, allowNumber:true,
              startNum:1, questionRange:"1–5",
              fields:[
            ...
            { id:"lp1q7", num:7, type:"fill",
              text:"Jordan signs up for the ______ membership.",
              wordLimit:1, allowNumber:true, answer:"Silver", altAnswers:["silver"] },
            { id:"lp1q8", num:8, type:"fill",
              text:"The Silver membership costs £______ per month.",
              wordLimit:1, allowNumber:true, answer:"38", altAnswers:["thirty-eight","thirty eight"] },
            { id:"lp1q9", num:9, type:"fill",
              text:"The swimming pool is closed on ______ evenings.",
              wordLimit:1, allowNumber:true, answer:"Wednesday", altAnswers:["wednesday"] },
            { id:"lp1q10", num:10, type:"fill",
              text:"The sports centre is on Canfield Road, just past the ______.",
              wordLimit:1, allowNumber:true, answer:"library", altAnswers:["the library"] }
          ]
        },
        {
          id: "l_p2", partNum: 2,
...
Now, before we set off, a few things to note about facilities. The Visitor Centre, where we are now, has toilets, a small café serving hot drinks and light lunches, and a gift shop. The café closes at half past three, so please plan your visit accordingly.
...
Any questions? No? Wonderful. Let's head off towards the wetland boardwalk first.`,
          questions: [
            ...
            { id:"lp2q11", num:11, type:"mcq", text:"How large is Ferndale Valley Nature Reserve?",
              options:["A. 230 hectares","B. 310 hectares","C. 340 hectares"], answer:"C" },
            { id:"lp2q12", num:12, type:"mcq", text:"What is described as one of the largest surviving colonies in the country?",
              options:["A. Kingfishers","B. Water voles","C. Skylarks"], answer:"B" },
            { id:"lp2q13", num:13, type:"mcq", text:"Which trail includes a wetland boardwalk?",
              options:["A. Green Trail","B. Blue Trail","C. Red Trail"], answer:"B" },
            { id:"lp2q14", num:14, type:"mcq", text:"Why must visitors keep to marked paths on the Red Trail?",
              options:["A. Paths near the viewpoint are steep and dangerous","B. The meadow contains nesting skylarks","C. Construction work is in progress"], answer:"B" },
            // Q 15-16: Multi-select cluster (real Cambridge pattern — Mark TWO letters A-E)
            { id:"lp2q15_16", num:15, type:"mcq_multi",
            ...
            { id:"lp2q17_18", num:17, type:"mcq_multi",
            ...
            { id:"lp2q19_20", num:19, type:"mcq_multi",
...
Felix: Agreed. That's a strong choice.`,
          questions: [
            { id:"lp3q21", num:21, type:"mcq", text:"What topic has Amara chosen to focus on?",
              options:["A. Green roofs","B. Passive house design","C. Living walls","D. Embodied carbon"], answer:"B" },
            { id:"lp3q22", num:22, type:"mcq", text:"Why does Felix choose the topic of green roofs?",
              options:["A. It is required by the professor","B. It connects to a previous module on biodiversity","C. Amara suggested it to him","D. The reading list covers it in most detail"], answer:"B" },
            { id:"lp3q23", num:23, type:"mcq", text:"What change did Professor Kim make to the assignment?",
              options:["A. She removed the case study requirement","B. She changed the submission format","C. She moved the deadline forward by several days","D. She added two new required readings"], answer:"C" },
            { id:"lp3q24", num:24, type:"mcq", text:"How many articles has Amara already found?",
              options:["A. Four","B. Five","C. Six","D. Eight"], answer:"C" },
            { id:"lp3q25", num:25, type:"mcq", text:"What is the problem with two of Amara's articles?",
              options:["A. They are too old to be relevant","B. They are not peer-reviewed","C. They are behind a paywall","D. They are not available in English"], answer:"C" },
            { id:"lp3q26", num:26, type:"mcq", text:"What year is the World Green Building Council report that Felix found?",
              options:["A. 2020","B. 2021","C. 2022","D. 2023"], answer:"D" },
            { id:"lp3q27", num:27, type:"mcq", text:"When do Amara and Felix agree to meet?",
              options:["A. Today at 3 pm","B. Tomorrow at 11 am","C. Tomorrow at 2 pm","D. Friday at 11 am"], answer:"B" },
            { id:"lp3q28", num:28, type:"mcq", text:"Why does Amara prefer room three in the library?",
              options:["A. It is larger than room four","B. It has a whiteboard and wall screen","C. It is quieter than other rooms","D. It is available immediately"], answer:"B" },
            { id:"lp3q29", num:29, type:"mcq", text:"What does Professor Kim say about the case study?",
              options:["A. It is compulsory","B. It is not recommended for this assignment","C. It is optional but strongly recommended","D. It must be a UK-based building"], answer:"C" },
            { id:"lp3q30", num:30, type:"mcq", text:"What is the Brock Environmental Centre notable for?",
              options:["A. Being the world's tallest green roof building","B. Being both net zero energy and net zero water","C. Using only locally sourced materials","D. Having the largest living wall in North America"], answer:"B" }
          ]
        },
        {
          id: "l_p4", partNum: 4,
...
In summary: bioluminescence is chemically driven by luciferin and luciferase, it is remarkably widespread in marine environments, serves multiple ecological functions from predation to camouflage, and has significant applications in biomedical research and potentially in environmental monitoring.`,
          questions: [
            { id:"lp4q31", num:31, type:"mcq", text:"What enzyme is involved in the bioluminescent chemical reaction?",
              options:["A. Luciferin","B. Luciferase","C. Chlorophyll","D. Lipase"], answer:"B" },
            ...
            { id:"lp4q33", num:33, type:"mcq", text:"What wavelength range does most marine bioluminescence fall within?",
              options:["A. 300–400 nm","B. 460–520 nm","C. 550–620 nm","D. 680–750 nm"], answer:"B" },
            { id:"lp4q34", num:34, type:"fill", text:"An estimated ______% of ocean organisms are bioluminescent.", answer:"76" },
            { id:"lp4q35", num:35, type:"mcq", text:"How do fireflies use bioluminescence?",
              options:["A. For camouflage against predators","B. To attract prey","C. For sexual signalling through flash patterns","D. To warn other insects of danger"], answer:"C" },
            { id:"lp4q36", num:36, type:"mcq", text:"What is counter-illumination camouflage?",
              options:["A. Producing bright flashes to confuse predators","B. Matching the downwelling light to avoid detection from below","C. Changing colour to blend with background","D. Emitting red light to become invisible in deep water"], answer:"B" },
            { id:"lp4q37", num:37, type:"mcq", text:"How does the anglerfish use bioluminescence?",
              options:["A. For camouflage","B. To communicate with its mate","C. As a lure to attract prey","D. To disorient predators"], answer:"C" },
            { id:"lp4q38", num:38, type:"mcq", text:"What did the discovery related to jellyfish proteins win in 2008?",
              options:["A. Nobel Prize in Physics","B. Nobel Prize in Medicine","C. Nobel Prize in Chemistry","D. Nobel Prize in Biology"], answer:"C" },
            { id:"lp4q39", num:39, type:"mcq", text:"What future application involves using bioluminescent bacteria?",
              options:["A. Replacing electric lighting in homes","B. Monitoring environmental pollution","C. Producing biofuel from algae","D. Creating glow-in-the-dark crops"], answer:"B" },
            { id:"lp4q40", num:40, type:"mcq", text:"Which best describes the lecture's conclusion about bioluminescent plants?",
              options:["A. They are currently in widespread commercial use","B. They will replace conventional lighting within ten years","C. The idea remains largely speculative","D. They have been proven effective in laboratory conditions"], answer:"C" }
          ]
        }
      ]
    },
    ...
    reading: {
      bandTable: [
        [40,9],[39,9],[38,8.5],[37,8.5],[36,8],[35,8],[34,7.5],[33,7.5],
        [32,7],[31,7],[30,6.5],[29,6.5],[28,6],[27,6],[26,6],[25,5.5],
        [23,5.5],[22,5.5],[21,5],[20,5],[19,5],[18,4.5],[17,4.5],[16,4.5],
        [15,4],[14,4],[13,4],[0,0]
      ],
      passages: [
        {
...
The debate reflects a broader tension in conservation: should limited resources be concentrated on the most ecologically valuable areas, or distributed more broadly to engage the greatest number of people? There is no simple answer. What is clear is that urban rewilding, whether or not it fully delivers the biodiversity benefits its champions promise, is reshaping how millions of people relate to the natural world.`,
          questions: [
            ...
            { id:"rp1q2", num:2, type:"tfng", text:"Soulé and Noss originally designed the rewilding framework for urban settings.", answer:"FALSE", explanation:"The passage explicitly states the vision 'was primarily rural in scope'." },
            ...
            { id:"rp1q11", num:11, type:"mcq", text:"Which of the following best describes Professor Varma's view on urban rewilding?",
              options:["A. It is the most cost-effective conservation strategy available","B. Its fragmented urban context limits its ecological value","C. It should replace rural conservation programmes","D. It is primarily beneficial for human health rather than wildlife"], answer:"B" },
            { id:"rp1q12", num:12, type:"mcq", text:"According to the passage, what is one key purpose served by urban rewilding beyond biodiversity?",
              options:["A. It reduces urban flood risk","B. It directly funds rural conservation","C. It educates city residents and builds environmental awareness","D. It removes the need for traditional conservation"], answer:"C" },
            { id:"rp1q13", num:13, type:"mcq", text:"What central debate does the passage describe in conservation?",
              options:["A. Whether urban areas or rural areas have more biodiversity","B. Whether rewilding or traditional conservation is scientifically valid","C. Whether resources should focus on high-value areas or engage more people","D. Whether governments or charities should fund conservation"], answer:"C" }
          ]
        },
        {
          id: "rp2",
...
Whether these interventions will prove sufficient remains uncertain. What is clear is that the attention economy will define the contours of public health, democratic discourse, and individual cognition for decades to come.`,
          questions: [
            { id:"rp2q14", num:14, type:"match_heading", text:"Which paragraph best matches the heading: 'Early warnings about the value of attention'?",
              options:["A. Paragraph 1","B. Paragraph 2","C. Paragraph 3","D. Paragraph 4"], answer:"A",
              explanation:"Paragraph 1 introduces Herbert Simon's 1971 observation about the poverty of attention." },
            { id:"rp2q15", num:15, type:"match_heading", text:"Which paragraph best matches: 'The engineered design of maximum engagement'?",
              options:["A. Paragraph 2","B. Paragraph 3","C. Paragraph 4","D. Paragraph 5"], answer:"B",
            ...
            { id:"rp2q16", num:16, type:"match_heading", text:"Which paragraph best matches: 'Research linking platform use to cognitive and emotional harm'?",
              options:["A. Paragraph 2","B. Paragraph 3","C. Paragraph 4","D. Paragraph 6"], answer:"C",
              explanation:"Paragraph 4 discusses the University of Gothenburg research and the smartphone desk study." },
            { id:"rp2q17", num:17, type:"match_heading", text:"Which paragraph best matches: 'Arguments in defence of the digital attention model'?",
              options:["A. Paragraph 3","B. Paragraph 4","C. Paragraph 5","D. Paragraph 6"], answer:"C",
              explanation:"Paragraph 5 presents counterarguments about consumer surplus and complexity of harm." },
            { id:"rp2q18", num:18, type:"match_heading", text:"Which paragraph best matches: 'Government responses to the attention economy'?",
              options:["A. Paragraph 4","B. Paragraph 5","C. Paragraph 6","D. Paragraph 7"], answer:"C",
            ...
            { id:"rp2q22", num:22, type:"mcq", text:"According to the Psychological Science study, what reduced participants' cognitive capacity?",
              options:["A. Using a smartphone while working","B. Having a smartphone visible on a desk, even when off","C. Receiving notifications during a task","D. Using social media immediately before a test"], answer:"B" },
            ...
            { id:"rp2q26", num:26, type:"mcq", text:"What does the final paragraph suggest about regulatory interventions in the attention economy?",
              options:["A. They will definitely solve the problem","B. They are unnecessary given the benefits of digital platforms","C. Their effectiveness is uncertain but the issue's importance is not","D. They are too late to have any meaningful impact"], answer:"C" }
          ]
        },
        {
          id: "rp3",
...
The honest assessment, shared by many practitioners, is that quantum computing will be transformatively useful — but for a narrower range of problems than the public narrative suggests, and on a longer timeline. The technology is genuinely progressing, but claims of imminent, broad-spectrum disruption routinely outpace the evidence.`,
          questions: [
            { id:"rp3q27", num:27, type:"mcq", text:"What is the author's primary view of current claims about quantum computing?",
              options:["A. They are largely accurate and supported by evidence","B. They are consistently understated given the technology's potential","C. They are more dramatic than the current reality warrants","D. They focus too narrowly on cryptographic threats"], answer:"C" },
            { id:"rp3q28", num:28, type:"mcq", text:"What property allows quantum computers to explore many computational paths simultaneously?",
              options:["A. Decoherence","B. Classical bit processing","C. Superposition and entanglement","D. Fault-tolerant architecture"], answer:"C" },
            { id:"rp3q29", num:29, type:"mcq", text:"According to the passage, what is the main problem with current quantum computers?",
              options:["A. They are too expensive to operate","B. Their qubits lose quantum states due to environmental interference","C. Their speed is slower than classical computers for all tasks","D. They cannot perform calculations involving more than two qubits"], answer:"B" },
            { id:"rp3q30", num:30, type:"mcq", text:"What criticism was made of Google's Willow chip benchmark?",
              options:["A. The benchmark was performed incorrectly","B. The benchmark was designed to disadvantage classical machines","C. The chip had fewer qubits than claimed","D. The result could not be replicated"], answer:"B" },
            ...
            { id:"rp3q38", num:38, type:"mcq", text:"What does the passage say about the development of post-quantum cryptography?",
              options:["A. It is still being researched with no agreed standards","B. It was developed but not yet approved by any body","C. Standards were approved by NIST in 2024","D. It will only be needed once practical quantum computers exist"], answer:"C" },
            { id:"rp3q39", num:39, type:"mcq", text:"Which area does the passage say quantum computing is NOT yet ready to disrupt imminently?",
              options:["A. Quantum chemistry simulations","B. Current encryption standards","C. Materials science","D. Drug discovery research"], answer:"B" },
            { id:"rp3q40", num:40, type:"mcq", text:"What is the most accurate summary of the passage's conclusion?",
              options:["A. Quantum computing will not fulfil any of its promised applications","B. Quantum computing will be broadly transformative within five years","C. Quantum computing will be valuable but for fewer applications and on a longer timeline than claimed","D. Quantum computing is a misunderstood technology that poses no threat to existing systems"], answer:"C" }
          ]
        }
      ]
    },
    ...
    writing: {
      task1_academic: [
        {
          id:"wa1", title:"Bar chart — Renewable energy sources",
...
(178 words)`,
        ...
        {
          id:"wa2", title:"Line graph — Internet usage by age group",
...
(168 words)`,
      ...
      general_task1: [
        {
          id:"wg1", title:"Letter to a landlord about repairs",
...
I'd strongly recommend it to anyone who hasn't seen it.`,
  ...
  toefl: {
    reading: {
      passages: [
        {
          id:"tr1", title:"The Domestication of the Dog",
...
Recent research has focused on the neurological basis of the human-dog bond. Studies using functional MRI have shown that dogs respond to the scent of their owners with heightened activation of the caudate nucleus — a brain region associated with positive anticipation and reward. Parallel studies have found that interactions between dogs and their owners trigger the release of oxytocin, the neuropeptide associated with social bonding, in both species simultaneously. These findings suggest that the human-dog relationship is not merely a trained association but a genuine mutual bond with neurological correlates.`,
          questions:[
            { id:"trq1", num:1, type:"mcq", text:"The passage suggests that the domestication of dogs is significant because it",
              options:["A. proved that wolves could be entirely tamed","B. predates nearly all other elements of modern civilisation","C. provided humans with their first source of protein","D. occurred simultaneously in every inhabited region"], answer:"B" },
            { id:"trq2", num:2, type:"mcq", text:"According to the self-domestication hypothesis, wolves gained advantage by",
              options:["A. forming hunting packs with early humans","B. being deliberately raised by humans from cubs","C. scavenging near human settlements and becoming less fearful","D. migrating to areas with abundant prey"], answer:"C" },
            { id:"trq3", num:3, type:"vocab", text:"The word 'tractability' in paragraph 2 is closest in meaning to",
              options:["A. intelligence","B. speed","C. manageability","D. independence"], answer:"C" },
            { id:"trq4", num:4, type:"mcq", text:"What does ancient DNA evidence reveal about dog domestication?",
              options:["A. It occurred in a single location approximately 15,000 years ago","B. It may have happened more than once in separate geographic regions","C. It was driven entirely by human selection rather than self-domestication","D. It took place exclusively in East Asia"], answer:"B" },
            { id:"trq5", num:5, type:"mcq", text:"What does the passage identify as remarkable about dogs' social intelligence?",
              options:["A. It is superior to that of wolves in hunting contexts","B. It enables them to learn over three hundred distinct commands","C. It exceeds that of chimpanzees in interpreting human social cues","D. It developed entirely through domestication in a single generation"], answer:"C" },
            { id:"trq6", num:6, type:"mcq", text:"What does the fMRI research described in the final paragraph indicate?",
              options:["A. Dogs cannot distinguish their owners from strangers by scent","B. Dogs experience reward-associated brain activation in response to their owners' scent","C. The caudate nucleus controls dogs' ability to follow pointing gestures","D. Oxytocin release occurs only in dogs, not in humans, during interaction"], answer:"B" },
            { id:"trq7", num:7, type:"inference", text:"It can be inferred from the final paragraph that the human-dog relationship",
              options:["A. is primarily based on training and conditioned responses","B. has neurological characteristics that parallel social bonding between humans","C. is less emotionally significant for dogs than for their owners","D. was only recognised as a genuine bond after the development of fMRI technology"], answer:"B" },
            { id:"trq8", num:8, type:"mcq", text:"Which of the following does the passage NOT mention as a role dogs played in human society?",
              options:["A. Hunting","B. Herding","C. Warfare","D. Companionship"], answer:"C" },
            { id:"trq9", num:9, type:"vocab", text:"The word 'correlates' in the final sentence is closest in meaning to",
              options:["A. symptoms","B. opposites","C. associated features","D. treatments"], answer:"C" },
            { id:"trq10", num:10, type:"summary", text:"Select the three statements that best summarise the key ideas of the passage.",
...
This is why economists consistently recommend that decision-makers think at the margin rather than in all-or-nothing terms. The right question is almost never 'should we do X or Y' — it's 'how much of X and how much of Y produces the optimal outcome?'`,
          questions:[
            { id:"tlq1", num:1, type:"mcq", text:"What is the professor's main point in this lecture?",
              options:["A. Students should take part-time jobs rather than study","B. Opportunity cost is a foundational economic concept that affects all decision-making","C. Government spending decisions ignore economic theory","D. Marginal analysis is too complex for real-world use"], answer:"B" },
            { id:"tlq2", num:2, type:"mcq", text:"According to the professor, what is the opportunity cost of choosing to study on Saturday afternoon?",
              options:["A. The cost of textbooks","B. The stress of the upcoming exam","C. The income that could have been earned working","D. The social activities that might be missed"], answer:"C" },
            { id:"tlq3", num:3, type:"mcq", text:"Why does the professor say opportunity cost is 'almost always invisible'?",
              options:["A. It is calculated using complex formulas","B. People focus on tangible outcomes and systematically undercount what they give up","C. It only applies to government policy, not individual decisions","D. Economists have only recently discovered the concept"], answer:"B" },
            { id:"tlq4", num:4, type:"mcq", text:"What does 'thinking at the margin' mean according to the professor?",
              options:["A. Reducing spending on all optional expenses","B. Focusing on whether the next unit of an action adds sufficient value","C. Considering the total cost of a decision over its lifetime","D. Consulting economic experts before making major decisions"], answer:"B" },
            { id:"tlq5", num:5, type:"mcq", text:"How does the professor describe the return from additional hours of study?",
              options:["A. Constant — each additional hour produces the same benefit","B. Increasing — each additional hour is more valuable than the last","C. Diminishing — additional hours produce progressively smaller benefits","D. Zero — study beyond two hours has no measurable effect"], answer:"C" }
          ]
        }
      ]
    },
    speaking: [
      {
        id:"ts1", taskNum:1, type:"independent",
      ...
      {
        id:"ts2", taskNum:2, type:"integrated_campus",
...
Student 2: Maybe, but not every resource I need is available digitally. Some of the older journals in my field are physical-only collections. The change really disadvantages humanities students in particular.`,
      ...
      {
        id:"ts3", taskNum:3, type:"integrated_academic",
...
The professor uses smoking as an example. A person who smokes while believing smoking causes cancer experiences this tension. Rather than simply quitting — the most rational resolution — people typically use easier strategies. One approach is to change the belief: the smoker might convince themselves the scientific evidence on cancer is overstated. Another is to find reconciling information: they might focus on examples of heavy smokers who lived long lives. Both strategies preserve the behaviour while reducing the psychological discomfort. The professor notes this illustrates how effectively our minds protect existing actions rather than challenging them.`
      ...
      {
        id:"ts4", taskNum:4, type:"integrated_lecture",
        ...
        prepSeconds:20, responseSeconds:60,
...
(185 words)`
      ...
      {
        id:"tw2", type:"academic_discussion",
...
(310 words)`,
    ...
    verbal: [
      { id:"gv1", type:"text_completion_1blank",
        ...
        options:["A. orthodox","B. tendentious","C. provisional","D. laconic","E. equitable"], answer:"B",
      ...
      { id:"gv2", type:"text_completion_2blank",
      ...
      { id:"gv3", type:"sentence_equivalence",
      ...
      { id:"gv4", type:"text_completion_1blank",
        ...
        options:["A. enthusiasm","B. scepticism","C. indifference","D. alarm","E. corroboration"], answer:"B",
      ...
      { id:"gv5", type:"reading_comprehension",
        ...
        questions:[
          { id:"gv5q1", text:"The passage primarily argues that",
            ...
            answer:"C" },
          { id:"gv5q2", text:"Multiple independent discoveries of the same finding are cited in order to",
      ...
      { id:"gv6", type:"text_completion_1blank",
        ...
        options:["A. intransigence","B. pragmatism","C. pedantry","D. belligerence","E. vacillation"], answer:"B",
      ...
      { id:"gv7", type:"sentence_equivalence",
    ...
    quantitative: [
      { id:"gq1", type:"problem_solving",
        ...
        options:["A. 32%","B. 35%","C. 30%","D. 28%","E. 33%"], answer:"A",
        solution:"Original price P. After 20% discount: 0.80P. After additional 15% off 0.80P: 0.80P × 0.85 = 0.68P. Total discount = P − 0.68P = 0.32P = 32%.",
        concept:"Successive percentage discounts: multiply the factors (1 − r₁)(1 − r₂), not add them." },
      { id:"gq2", type:"quantitative_comparison",
      ...
      { id:"gq4", type:"problem_solving",
        ...
        options:["A. 96 km/h","B. 100 km/h","C. 98 km/h","D. 94 km/h","E. 102 km/h"], answer:"A",
        solution:"Average speed = 2d/(d/80 + d/120) = 2/(1/80 + 1/120) = 2/((3+2)/240) = 2×240/5 = 96 km/h. Harmonic mean of the two speeds.",
        concept:"When distance is constant in both directions, use the harmonic mean: 2ab/(a+b)." },
      { id:"gq5", type:"quantitative_comparison",
        text:"x > 0. Column A: x². Column B: x³",
        options:["A. Column A is greater","B. Column B is greater","C. The two quantities are equal","D. The relationship cannot be determined from the information given"],
        answer:"D",
        solution:"If x = 0.5: x² = 0.25, x³ = 0.125 → A greater. If x = 2: x² = 4, x³ = 8 → B greater. If x = 1: equal. Cannot determine.",
        concept:"Test multiple cases (fraction, whole number, 1) in QC with variables." },
      { id:"gq6", type:"problem_solving",
        text:"The sum of the interior angles of a polygon is 1,080°. How many sides does the polygon have?",
        options:["A. 6","B. 7","C. 8","D. 9","E. 10"], answer:"C",
      ...
      { id:"gq7", type:"problem_solving",
        ...
        options:["A. 3","B. 5","C. 7","D. 9","E. 12"], answer:"A",
  ...
  gmat: {
    quantitative: [
      { id:"gmq1", type:"problem_solving",
        text:"If 3x + 2y = 18 and x − y = 3, what is the value of x?",
        options:["A. 3","B. 4","C. 5","D. 6","E. 7"], answer:"B",
      ...
      { id:"gmq2", type:"problem_solving",
        ...
        options:["A. 2.4","B. 2.0","C. 3.0","D. 2.6","E. 1.8"], answer:"A",
      ...
      { id:"gmq3", type:"problem_solving",
        text:"A rectangular garden is 3 times as long as it is wide. If the perimeter is 96 metres, what is the area of the garden?",
        options:["A. 432 m²","B. 324 m²","C. 648 m²","D. 540 m²","E. 486 m²"], answer:"A",
        solution:"Let width = w, length = 3w. Perimeter = 2(w + 3w) = 8w = 96 → w = 12 m. Length = 36 m. Area = 12 × 36 = 432 m².",
        concept:"Set up algebra from the ratio and perimeter constraints, then find area." },
      { id:"gmq4", type:"problem_solving",
        text:"What is 15% of 240?",
        options:["A. 32","B. 36","C. 38","D. 40","E. 42"], answer:"B",
        solution:"15% × 240 = 0.15 × 240 = 36.", concept:"Percentage calculation: convert percent to decimal and multiply." },
      { id:"gmq5", type:"problem_solving",
        ...
        options:["A. $25,000","B. $25,100","C. $24,900","D. $25,200","E. $24,800"], answer:"A",
        solution:"22,000 = Original × 0.88 → Original = 22,000 / 0.88 = 25,000.",
        concept:"Percentage decrease: final = original × (1 − rate). Reverse: original = final / (1 − rate)." }
    ],
    verbal: [
      { id:"gmv1", type:"critical_reasoning",
        subtype:"weaken",
      ...
      { id:"gmv2", type:"critical_reasoning",
        subtype:"assumption",
      ...
      { id:"gmv3", type:"reading_comprehension",
...
The significance of the framework lies not merely in its descriptive power but in its normative implications: epistemic injustice is a genuine wrong, not merely a cognitive error, because it harms the victim in a specifically human capacity — the ability to participate as a full epistemic agent in social life.`,
        questions:[
          { id:"gmv3q1", text:"The passage is primarily concerned with",
            ...
            answer:"B" },
          { id:"gmv3q2", text:"According to the passage, hermeneutical injustice differs from testimonial injustice in that it",
    ...
    dataInsights: [
      ...
      { id:"gdi3", type:"two_part_analysis",
  ...
  pte: {
    speakingWriting: [
      ...
      { id:"pte_rs1", type:"repeat_sentence",
      ...
      { id:"pte_di1", type:"describe_image",
      ...
      { id:"pte_asq1", type:"answer_short_question",
        questions:[
      ...
      { id:"pte_swt1", type:"summarize_written_text",
      ...
      { id:"pte_essay1", type:"write_essay",
...
(245 words)`,
    ...
    reading: [
      { id:"pte_fib1", type:"fill_in_blanks_rw",
      ...
      { id:"pte_ro1", type:"reorder_paragraphs",
    ...
    listening: [
      { id:"pte_wfd1", type:"write_from_dictation",
        sentences:[
      ...
      { id:"pte_hiw1", type:"highlight_incorrect_words",
...
(156 words)`,
    ...
    speaking: [
      { id:"cs1", task:1, name:"Giving Advice",
        ...
        prepSeconds:30, responseSeconds:90,
...
Once you have some savings and a clearer plan, quitting becomes a much smarter risk. Starting a business is exciting — I just don't want you to put yourself in a position where you're forced to make desperate decisions because of financial stress. Does that make sense?`
  ...
  duolingo: {
    tasks: [
      { id:"det1", type:"read_and_complete",
      ...
      { id:"det4", type:"write_about_photo",
...
window.LP_SCORE = {
  ieltsListeningBand(correct) {
    ...
    for (const [score, band] of t) { if (correct >= score) return band; }
    return 0;
  },
