  ...
  const ARTICLES = [
    {
      ...
      sections: [
        ...
        { h: "Scoring", body: "IELTS reports band scores from 0 to 9 in 0.5 increments per section, with an overall band rounded to the nearest 0.5. Since January 2026, TOEFL iBT reports a new 1–6 band score in half-points, aligned to the CEFR, with a comparable 0–120 total also shown during a two-year transition. Many universities still publish requirements on the older 0–120 scale for now — commonly TOEFL 80+ (or IELTS 6.0–6.5) for undergraduate study and TOEFL 100+ (or IELTS 7.0+) for competitive graduate programmes — so always confirm your target programme's stated requirement." },
