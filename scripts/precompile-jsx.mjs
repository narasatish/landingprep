...
let esbuildModule;
try { esbuildModule = await import("esbuild"); } catch (e) {
  console.log("↷ esbuild not installed — skipping JSX precompile (pre-compiled .js files used)");
  process.exit(0);
}
const { transformSync } = esbuildModule;
