...
let sharp; try { sharp = require("sharp"); } catch (e) { console.log("↷ skip make-app-assets: sharp not installed (pre-built icons in repo are used on Render)"); process.exit(0); }
